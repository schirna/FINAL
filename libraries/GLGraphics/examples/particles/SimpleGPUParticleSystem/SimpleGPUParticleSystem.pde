// Particle system simulated on the GPU.
// By Andres Colubri
...
{   
    ...
    floatTexParams.minFilter = GLTexture.NEAREST; // We don't want linear filtering for GPGPU calculations.
    floatTexParams.magFilter = GLTexture.NEAREST;
