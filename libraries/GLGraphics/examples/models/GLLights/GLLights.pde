...
void draw() {    
    ...
    // All the defaul lights (one directional and one
    // ambient are turned off). This method is accessible
    // only through the GLGraphics renderer because is
    // not part of the Processing API.
