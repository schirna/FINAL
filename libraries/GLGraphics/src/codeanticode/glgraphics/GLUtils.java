...
public class GLUtils {
  ...
  static public int parsePrimitiveType(String typeStr) {
    if (typeStr.equals("points"))
      return GL.GL_POINTS;
    else if (typeStr.equals("line_strip"))
      return GL.GL_LINE_STRIP;
    else if (typeStr.equals("line_loop"))
      return GL.GL_LINE_LOOP;
    else if (typeStr.equals("lines"))
      return GL.GL_LINES;
    else if (typeStr.equals("triangle_strip"))
      return GL.GL_TRIANGLE_STRIP;
    else if (typeStr.equals("triangle_fan"))
      return GL.GL_TRIANGLE_FAN;
    else if (typeStr.equals("triangles"))
      return GL.GL_TRIANGLES;
    else if (typeStr.equals("quad_strip"))
      return GL.GL_QUAD_STRIP;
    else if (typeStr.equals("quads"))
      return GL.GL_QUADS;
    else if (typeStr.equals("polygon"))
  ...
  static public int parsePrimitiveTypeUpperCase(String typeStr) {
    if (typeStr.equals("POINTS"))
      return GL.GL_POINTS;
    else if (typeStr.equals("POINT_SPRITES"))
      return GL.GL_POINTS;
    else if (typeStr.equals("LINE_STRIP"))
      return GL.GL_LINE_STRIP;
    else if (typeStr.equals("LINE_LOOP"))
