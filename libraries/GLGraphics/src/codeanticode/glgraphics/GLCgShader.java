...
/**
 ...
 /**
  ...
  /**
   * Sets the texture parameter with name to the given value 
   * 
   * @param name
   *          String
   * @param tex
   *          GLTexture
   */               
  public void setTexParameter(String name, int val) {
    CGparameter p = CgGL.cgGetNamedParameter(currProgram, name);
    if (p != null)  CgGL.cgSetParameter1i(p, val);    
  }
  ...
  private void createVertexProgram(String source, String file) {  
    ...
    vertexProgram = CgGL.cgCreateProgram(context, CgGL.CG_SOURCE, source, vertexProfile, null, null);
  ...
  private void createGeometryProgram(String source, String file) {    
    ...
    // else CgGL.cgGLSetOptimalOptions( geometryProfile );
     ...
     geometryProgram = CgGL.cgCreateProgram(context, CgGL.CG_SOURCE, source, CgGL.CG_PROFILE_ARBFP1, null, null); 
  ...
  private void createFragmentProgram(String source, String file) {    
    ...
    fragmentProgram = CgGL.cgCreateProgram(context, CgGL.CG_SOURCE, source, fragmentProfile, null, null);
